#!/usr/bin/env python3
"""
Fractional Wave Equation Benchmark
Specific experimental script for fractional wave equation validation
"""
...
from src.data.fractional_data_generator import generate_fractional_wave_data

class FractionalWaveEquationBenchmark:
    """Benchmark for fractional wave equation"""
    ...
    def run_single_method_benchmark(self, alpha=0.5, method='caputo'):
        ...
        print(f"Running fractional wave equation benchmark: α={alpha}, method={method}")
        ...
        # Generate data
        train_data, test_data = generate_fractional_wave_data(
            alpha=alpha,
            domain_size=32,
            time_steps=50,
            batch_size=50
    ...
    def run_comprehensive_benchmark(self):
        ...
        print("Starting Fractional Wave Equation Comprehensive Benchmark")
        print("=" * 60)
        
        # 1. Single method benchmark
        print("\n1. Single Method Benchmark")
        single_method_results = self.run_single_method_benchmark(alpha=0.5, method='caputo')
        self.save_results(single_method_results, 'wave_equation_single_method.json')
        ...
        self.save_results(multi_method_results, 'wave_equation_multi_method.json')
        ...
        self.save_results(alpha_sweep_results, 'wave_equation_alpha_sweep.json')
        ...
        self.save_results(method_comparison_results, 'wave_equation_method_comparison.json')
        
        print("\n" + "=" * 60)
        print("Fractional Wave Equation Benchmark Complete!")
